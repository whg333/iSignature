package com.whg.iSignature.web.interceptor;
...
import com.skylinematrix.util.net.http.HttpContext;
import com.skylinematrix.util.reflect.ReflectUtil;
import com.skylinematrix.util.string.StringUtil;
...
public class ControllerInterceptor implements HandlerInterceptor {
	...
	public static final boolean isLocalPlatform = true;
...
//    	logger.info(handler.getClass().getSimpleName()+", "+request.getRequestURI()+", "+request.getMethod()
//    		+", "+paramMap(request)+(queryStr == null ? "" : ", "+queryStr));
    ...
    public void postHandle(HttpServletRequest request, HttpServletResponse response, Object handler, ModelAndView modelAndView) throws Exception {
    	...
    	//response.setHeader("uncompress", "true");
		//response.setHeader("resp_content_type", "json");
    }
